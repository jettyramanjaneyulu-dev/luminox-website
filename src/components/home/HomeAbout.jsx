      ...
      <div className="container">
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            {/* Floating card 1 — years */}
            <div ref={floatCard1Ref} style={{
              position: 'absolute', bottom: -24, right: 0,
              width: '52%', background: 'white', borderRadius: 4,
              padding: '26px 30px',
              ...
              <div style={{
                ...
                color: '#6B4FA0', lineHeight: 1,
              }}>5+</div>
              <div style={{
                fontFamily: "'Jost', sans-serif",
                fontSize: 15, color: '#8A8A9A',
            ...
            {/* Floating card 2 — award */}
            <div ref={floatCard2Ref} style={{
              ...
              <div style={{
                ...
                color: '#6B4FA0', letterSpacing: 1, marginTop: 8,
              }}>AWARD WINNING</div>
            </div>
          </div>
          ...
          <div>
            ...
            <div ref={pointsRef} style={{
              ...
              {[
                '✦ Board-certified dermatologists & cosmetologists',
                '✦ USFDA approved technology & equipment',
                '✦ Personalized treatment plans for every patient',
                '✦ 10,000+ satisfied patients across all treatments',
              ].map((point, i) => (
                <div key={i} style={{
                  fontFamily: "'Jost', sans-serif",
                  fontSize: 16, color: '#2C2C4A',
